...
WebUI.setText(findTestObject('PracticeForm/Inputs/txt_Lastname'), findTestData('PracticeFormData').getValue('lastName', 
        1))

WebUI.setText(findTestObject('PracticeForm/Inputs/txt_Email'), findTestData('PracticeFormData').getValue('email', 1))

WebUI.click(findTestObject('PracticeForm/Radio/rdo_GenderMale'))

WebUI.setText(findTestObject('PracticeForm/Inputs/txt_Mobile'), findTestData('PracticeFormData').getValue('mobile', 1))
...
WebUI.setText(findTestObject('PracticeForm/Inputs/txt_CurrentAddress'), findTestData('PracticeFormData').getValue('currentAddress', 
        1))
...
WebUI.verifyElementText(findTestObject(null), 'Thanks for submitting the form')
